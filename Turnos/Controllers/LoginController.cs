    ...
    public class LoginController : Controller
    {
        ...
        public IActionResult Login(Login login)
        {
            ...
            {//Encriptacion de pass
                string PassEncrip = Encriptar(login.Password);

                var loginUsuario = _turnosContext.Logins.Where(l => l.Usuario == login.Usuario && l.Password == PassEncrip)
                    .FirstOrDefault();
                ...
                {
                    ViewData["ErrorLogin"] = "Error al iniciar sesion";
                    return View("Index");  
                }
            }
            return View("Index");  
